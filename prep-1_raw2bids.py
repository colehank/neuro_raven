...
warnings.filterwarnings("ignore", message=".*Encountered unsupported non-voltage units.*")
load_dotenv()
...
EVENT_ID = {
    ...
    # 1. 恒定规则
    'con_edg_s1on': 2,  'con_edg_s1off': 3,  'con_edg_s2on': 4,  'con_edg_s2off': 5,  'con_edg_reson': 6,  'con_edg_resoff': 7,
    'con_qty_s1on': 8,   'con_qty_s1off': 9,   'con_qty_s2on': 10,  'con_qty_s2off': 11,  'con_qty_reson': 12,  'con_qty_resoff': 13,
    'con_ara_s1on': 38, 'con_ara_s1off': 39, 'con_ara_s2on': 40, 'con_ara_s2off': 41, 'con_ara_reson': 42, 'con_ara_resoff': 43,
    'con_chi_s1on': 56, 'con_chi_s1off': 57, 'con_chi_s2on': 58, 'con_chi_s2off': 59, 'con_chi_reson': 60, 'con_chi_resoff': 61,

    # 2. 三分布规则
    'di3_qty_s1on': 14,  'di3_qty_s1off': 15,  'di3_qty_s2on': 16,  'di3_qty_s2off': 17,  'di3_qty_reson': 18,  'di3_qty_resoff': 19,
    'di3_edg_s1on': 26, 'di3_edg_s1off': 27, 'di3_edg_s2on': 28, 'di3_edg_s2off': 29, 'di3_edg_reson': 30, 'di3_edg_resoff': 31,
    'di3_ara_s1on': 44, 'di3_ara_s1off': 45, 'di3_ara_s2on': 46, 'di3_ara_s2off': 47, 'di3_ara_reson': 48, 'di3_ara_resoff': 49,
    'di3_chi_s1on': 62, 'di3_chi_s1off': 63, 'di3_chi_s2on': 64, 'di3_chi_s2off': 65, 'di3_chi_reson': 66, 'di3_chi_resoff': 67,

    # 3. 递增规则 
    'pro_qty_s1on': 20,   'pro_qty_s1off': 21,   'pro_qty_s2on': 22,  'pro_qty_s2off': 23,  'pro_qty_reson': 24,  'pro_qty_resoff': 25,
    'pro_edg_s1on': 32,  'pro_edg_s1off': 33,  'pro_edg_s2on': 34, 'pro_edg_s2off': 35, 'pro_edg_reson': 36, 'pro_edg_resoff': 37,
    'pro_ara_s1on': 50,  'pro_ara_s1off': 51,  'pro_ara_s2on': 52, 'pro_ara_s2off': 53, 'pro_ara_reson': 54, 'pro_ara_resoff': 55,
    'pro_chi_s1on': 68,  'pro_chi_s1off': 69,  'pro_chi_s2on': 70, 'pro_chi_s2off': 71, 'pro_chi_reson': 72, 'pro_chi_resoff': 73
}
...
def process_one(subid, runid, fp):
    ...
    write_raw_bids(raw, bids_path, overwrite=True, format="auto",
                   event_id=evid, events=ev,
                   )
...
# %%
    ...
    type_map = {
        'edg': 'symbol', 'qty': 'symbol', 
        'ara': 'non-symbol', 'chi': 'non-symbol'
    }
    level_map = {
        'edg': 'edges', 'qty': 'quantity', 
        'ara': 'arabic', 'chi': 'chinese'
    }
    status_map = {
        's1on': 'screen1_on', 's1off': 'screen1_off', 
        's2on': 'screen2_on', 's2off': 'screen2_off',
        'reson': 'response_start', 'resoff': 'response_end'
    }
    ...
    df.loc[df['event_name'] == 'begin', ['rule', 'stim_type', 'stim_level', 'status']] = 'run_start'
